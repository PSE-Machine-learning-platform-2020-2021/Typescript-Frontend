...
export class State implements IState {
    ...
    qr?: string;
    diagramSvg?: string;
    recordingSettings?: { newDataSetName: string, usedSensorTypes: number[], readTime: number, waitTime: number, availableSensorTypes: { sensorTypID: number; sensorType: string; chosen: boolean; }[]; } = { newDataSetName: "null", usedSensorTypes: [-1], readTime: -1, waitTime: -1, availableSensorTypes: [{ sensorTypID: -1, sensorType: "null", chosen: false }]};
    leadTime?: number;
