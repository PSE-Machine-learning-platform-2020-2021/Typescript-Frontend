...
test("creat and getter", () => {
    const label = new Label("Name", 17, { start: 0.2345, end: 2.4521 });
    expect(label.getID()).toBe(17);
    expect(label.getLabel().name).toBe("Name");
    expect(label.getLabel().labelID).toBe(17);
    expect(label.getLabel().span.start).toBe(0.2345);
    expect(label.getLabel().span.end).toBe(2.4521);
});
 ...
 */
test("setLabel", () => {
    const label = new Label("Laufen", 28, { start: 0, end: 17.456 });
    ...
    expect(label.getLabel().span.start).toBe(7.42);
    expect(label.getLabel().span.end).toBe(19);
    ...
    expect(label.getLabel().labelID).toBe(28);
    expect(label.getLabel().span.start).toBe(19.25);
    expect(label.getLabel().span.end).toBe(19.26);
